...
import com.ichi2.anki1.Fact.Field;
import com.ichi2.anki1.Utils.SqlCommandType;
...
//        }
    ...
    private boolean upgradeDeck() {
        ...
        if (mVersion < 39) {
            // Unsupported version
            upgradeNotes.add(com.ichi2.anki1.R.string.deck_upgrade_too_old_version);
            return false;
        }
        if (mVersion < 40) {
        ...
        if (mVersion < 61) {
            ...
            if (hasLaTeX()) {
                upgradeNotes.add(com.ichi2.anki1.R.string.deck_upgrade_version_61_has_latex);
                return false;
            }
